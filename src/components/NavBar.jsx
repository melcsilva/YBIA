...
export default function NavBar() {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 transition-all duration-300 bg-[var(--color-softblack)]/20 backdrop-blur-sm">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16 md:h-20">
          <div className="flex items-center space-x-1 group cursor-pointer">
            <div>
              <img
                src={logoYBIA}
                alt="Ybia"
                className="w-6 h-6 sm:w-40 sm:h-18"
              />
            </div>
          </div>
          ...
          <button
            className="md:hidden p-2 text-[var(--color-offwhitec)] hover:text-[var(--color-gold)]"
