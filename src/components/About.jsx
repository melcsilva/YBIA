...
export default function About() {
  ...
  return (
    <>
      <section
        id="about"
        className="relative min-h-[100vh] flex flex-col lg:flex-row items-center justify-between overflow-hidden py-20 bg-[var(--color-offwhitec)] px-8 lg:px-20 gap-10"
      >
        ...
        >
          ...
          <p className="text-lg leading-relaxed text-[var(--color-softblack)]">
            Nossa IA é projetada para aprender e se adaptar, assim como a
            natureza, garantindo que sua empresa não apenas acompanhe as
            mudanças, mas prospere nelas. Junte-se a nós e descubra como a
            tecnologia pode florescer em harmonia com o mundo ao nosso redor.
          </p>
        </motion.div>
        ...
        >
          <img
            src={about}
            alt="Sobre a Ybia"
            className="w-80 h-80 lg:w-[420px] lg:h-[420px] object-cover rounded-full shadow-lg shadow-yellow-500/50 hover:shadow-xl transition-transform duration-700 ease-in-out hover:scale-110"
          />
        </motion.div>
      </section>
      ...
      <section className="relative min-h-[100vh] flex flex-col items-center justify-center overflow-hidden py-24 px-8 lg:px-20 bg-gradient-to-b from-[#0a0a0a] via-[#1a1408] to-[var(--color-gold)]/10">
        ...
        {/* título */}
        <motion.h2
          className="relative z-10 text-5xl font-bold mb-10 text-[var(--color-offwhitec)] text-center"
          variants={fadeInUp}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }}
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between w-full max-w-6xl">
          ...
          {/* texto + botão */}
          <motion.div
            className="flex-1 text-center lg:text-left lg:pl-20 text-[var(--color-offwhitec)] mt-[-40px]"
            variants={fadeInUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
          ...
          >
            <p className="text-xl leading-relaxed text-[var(--color-offwhitec)]/90 mb-6">
              LuminAI é a nossa{" "}
              <span className="font-bold">inteligência artificial</span>, um
              colibri de luz que simboliza a harmonia entre natureza e
              tecnologia.
            </p>
            <p className="text-xl leading-relaxed text-[var(--color-offwhitec)]/90 mb-8">
              Ele aprende, conversa e ilumina caminhos, guiando empresas e
              pessoas por um universo onde a inteligência é viva, gentil e
              transformadora.
            </p>

            {/* botão do WhatsApp */}
            <a
              href="https://wa.me/5511939483539"
              target="_blank"
